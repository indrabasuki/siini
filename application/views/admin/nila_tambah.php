             ...
             <div class="col-md-12">
                 <div class="box box-primary">
                     ...
                     <div class="row">
                         <div class="col-md-3">
                             <div class="box-body">
                                 <div class="form-group"><label>NIM Mahasiswa</label><br>
                                     <div class="row">
                         ...
                         <div class="col-md-3">
                             <div class="box-body">
                                 <div class="form-group"><label>KODE Mata Kuliah</label><br>
                                     <div class="row">
                                         <div class="col-xs-10"> <input type="text" class="form-control" id="kode_mk" name="kode_mk" maxlength="5" placeholder="KODE Mata Kuliah" requiredreadonly></div>
                         ...
                         <div class="col-md-3">
                             <div class="box-body">
                                 <div class="form-group"><label>NID Dosen Pengajar</label><input type="text" class="form-control" id="nid" name="nid" maxlength="30" placeholder="NID Dosen Pengajar" required readonly></div>
                             </div>
                         </div>
                         <div class="col-md-9">
                             <div class="box-body">
                                 <div class="form-group"><label>Nama Dosen Pengajar</label><input type="text" class="form-control" id="nama_dosen" maxlength="30" placeholder="Nama Dosen Pengajar" required readonly></div>
                             </div>
                         </div>
                         <div class="col-md-5">
                             <div class="box-body">
                         ...
                         <div class="col-md-2">
                             <div class="box-body">
                                 <div class="form-group"><label>TANGGAL INPUT</label><input type="text" class="form-control" name="tgl_input" value="<?= date('Y-m-d') ?>" placeholder="TANGGAL INPUT" requiredreadonly></div>
                             </div>
                         </div>
                     </div>
                     <div class="box-footer"><button type="submit" name="submit" class="btn btn-success btn-flat">Simpan</button><a href="<?= base_URL() ?>admin/nilai" class="btn btn-warning btn-flat pull-right">Batal</a></div><?= form_close() ?>
                     <!--form end -->
                 </div>
                 <!--/.box -->
             </div>
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <table id="lookup2" class="table table-hover table-striped table-bordered">
                     ...
                     <tbody><?php foreach ($mtk as $m) { ?><tr class="pilihs" data-kode_mk="<?= $m->kode_mk ?>" data-nama_mk="<?= $m->nama_mk ?>" data-semester="<?= $m->semester ?>" data-nid="<?= $m->nid ?>" data-nama_dosen="<?= getDosen($m->nid) ?>">
