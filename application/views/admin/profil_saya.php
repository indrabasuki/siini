 ...
 <div class="content-wrapper">
     ...
     <section class="content-header">
         ...
         <ol class="breadcrumb">
             <li><a href="<?= base_URL() ?>admin/dashboard"><i class="fa fa-dashboard"></i>&nbsp;
                     Dashboard</a></li>
             ...
             <div class='col-md-3'>
                 <div class='box box-primary'>
                     <div class='box-body box-profile'>
                         <img class='profile-user-img img-responsive img-circle' src='<?= base_URL() . 'public/img/' . $foto ?>' alt='foto profil' style='width: 167px; height: 167px;'>
                         ...
                         <ul class='list-group list-group-unbordered'>
                             <li class='list-group-item'>
                                 <div class='row' align='center'>
                                     <font size='4px'>
                                         <div class='col-xs-4'>
                                             <b><a href='https://www.facebook.com/' target='_blank' title='Buka Facebook'><i class='fa
fa-facebook'></i></a></b>
                                         </div>
                                         <div class='col-xs-4'>
                                             <b><a href='https://www.twitter.com/' target='_blank' title='Buka Twitter'><i class='fa fatwitter'></i></a></b>
                                         </div>
                                         <div class='col-xs-4'>
                                             <b><a href='https://www.instagram.com/' target='_blank' title='Buka Instagram'><i class='fa
fa-instagram'></i></a></b>
                                         </div>
                                     </font>
                                 </div>
             ...
             <div class='col-md-9'>
                 <div class='box box-primary'>
                     ...
                     <div class='box-footer'>
                         ...
                         <a href='<?= base_URL() ?>admin/dashboard' type='button' class='btn btn-warning btn-flat pullright'>Batal</a>
                     </div>
                 </div>
             </div>
             <?= form_close() ?>
