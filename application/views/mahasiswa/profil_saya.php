...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if ($this->session->flashdata('simpan')) {
        ...
        } ?><?= form_open_multipart('mahasiswa/profil_saya', 'role="form"') ?><div class='row'>
            <div class='col-md-3'>
                <div class='box box-primary'>
                    <div class='box-body box-profile'><img class='profile-user-img img-responsive img-circle' src='<?= base_URL() . 'assets/img/' . $foto ?>' alt='foto profil' style='width: 167px; height: 167px;'>
                                ...
                                <div class='row' align='center'>
                                    <font size='4px'>
                                        <div class='col-xs-4'><b>
                                                <ahref='https: //www.facebook.com/' target='_blank' title='Buka Facebook'><i class='fa fa-facebook'></i></a>
                                            </b></div>
            ...
            <div class='col-md-9'>
                <div class='box box-primary'>
                    ...
                    <div class='box-body'>
                        <div class='row'>
                            <div class="col-md-12">
                                <div class="box-body">
                                    <div class="form-group"><label>NIM</label><input type="text" class="form-control" name="nim" value="<?= $ps['nim'] ?>" maxlength="20" placeholder="NIM" readonly></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="box-body">
                                    <div class="form-group"><label>Nama Mahasiswa</label><input type="text" class="form-control" name="nama_mhs" value="<?= $ps['nama_mhs'] ?>" maxlength="30" placeholder="Nama Mahasiswa"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <hr>
                ...
                <div class='box-footer'><button type='submit' name='submit' class='btn btn-success btn-flat'>Simpan</button><a href='<?= base_URL() ?>mahasiswa/dashboard' type='button' class='btn btn-warning btn-flat pull-right'>Batal</a></div>
            </div>
        </div><?= form_close() ?></section>
    <!--/.content -->
</div>
<!--/.content-wrapper -->