...
<script>
    $(function() {
        Datepicker.$('#datepicker').datepicker({
            ...
            todayBtn: true,
            todayHighlight: true
        }) //iCheck for checkbox and radio inputs$('input[type="checkbox"].minimal, input[type="radio"].minimal').iCheck({checkboxClass: 'icheckbox_minimal-blue',radioClass   : 'iradio_minimal-blue'})
    })
</script>
<!--Notifikasi -->
<script>
